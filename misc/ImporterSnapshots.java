/**
 * run as java ImporterSnapshots [dirtosearch]
 **/

import java.io.*;

public class ImporterSnapshots {
     ...
     * @param directory
     */
    public ImporterSnapshots(String directory) {
	super();
	this.directory = directory;
    }
 
    public static void main(String[] args) {
	ImporterSnapshots importer = new ImporterSnapshots(args[0]);
	importer.go();
    }
