/**
 * run as java ImporterFlex [dirtosearch]
 **/

import java.io.*;

public class ImporterFlex {
     ...
     * @param directory
     */
    public ImporterFlex(String directory) {
	super();
	this.directory = directory;
    }
 
    public static void main(String[] args) {
	ImporterFlex importer = new ImporterFlex(args[0]);
	importer.go();
    }
	...
	String jarName = fileName.substring(0, fileName.length() - 3) + "swc";
